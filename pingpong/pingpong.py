    ...
    try:
        ...
        for i, skin in enumerate(ball_skins, 1):
            try:
                ...
                desired_ball_size = (30, 30)  # например
                resources["images"][f"ball_{i}"] = pygame.transform.scale(
                    resources["images"][f"ball_{i}"],
                    desired_ball_size
                )
            except:
                pass
...
while True:
    ...
    if game_state == MENU:
        ...
        player1.topleft = (10, player1.y)
        player2.topleft = (WIDTH - resources["images"]["paddle"].get_width() - 10, player2.y)
